...
description: "A technical paper on deposit tokenization approaches aimed at business professionals."
layout: default
---
...
1. **Backed Deposit Tokens**
2. **Native Deposit Tokens**
...
- **Redemption**: When a customer withdraws funds, the bank’s smart contract or DLT infrastructure reduces (burns) the corresponding token amount on-chain and processes the settlement, either by delivering cash or transferring funds through another settlement mechanism. As soon as the on-chain balance is updated, it becomes the official deposit record. There is no separate deposit backing required because the “deposit” is the token itself.
...
- **Phased implementation**: Banks can start with limited use cases and gradually expand on-chain functionality. Pilots can be conducted in controlled environments.
- **Clear collateral**: If a blockchain issue arises, the underlying deposits remain intact in the bank’s off-chain ledger. In extreme scenarios, the bank can revert to existing infrastructure.
...
How do these differing features manifest in real-world applications? Below, we compare Backed and Native approaches across three primary use cases: **domestic remittances, B2B settlements, and cross-border payments**.
...
1. **Bank of Japan**: “Initiatives for Tokenized Bank Deposits Overseas,” *BOJ Review*, June 2024.
2. **European Banking Authority**: *Report on Tokenised Deposits*, December 2024.
3. **Oliver Wyman / Onyx (J.P. Morgan)**: *Deposit Tokens: A Foundation for Stable Digital Money*, February 2023.
4. **Swiss Bankers Association (SBA)**: *The Deposit Token – New money for digital Switzerland*, March 2023.
5. **JPMorgan Chase & Co.**: “JPM Coin and the Onyx Platform,” Press Release, 2020.
6. **BIS**: *Project Agorá Report*, 2023.
7. **Digital Currency Forum (Japan)**: Proof-of-Concept Reports and Analysis, 2022–2024.

---

**Copyright Notice / License**

This document is licensed under [Creative Commons Attribution 4.0 International](https://creativecommons.org/licenses/by/4.0/). You are free to share and adapt the material, provided appropriate credit is given and any changes are clearly indicated.
